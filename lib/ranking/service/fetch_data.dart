...
import 'package:cryptocurrency_ranking_app/ranking/model/crypto_model.dart';
...
class CryptoRepository extends ICryptoRepository {
  String url = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=20&convert=USD";
